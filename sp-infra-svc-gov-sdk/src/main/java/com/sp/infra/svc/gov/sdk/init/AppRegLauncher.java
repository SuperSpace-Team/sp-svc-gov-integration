...
import com.sp.infra.svc.gov.sdk.alm.init.AlmComponentInit;
...
import com.sp.infra.svc.gov.sdk.constant.ServiceUrlConstants;
...
import com.sp.infra.svc.gov.sdk.init.service.ConfigService;
import com.sp.infra.svc.gov.sdk.init.service.SendReceiveService;
    ...
    private String getSdkVersion() {
        ...
        try {
            InputStream is = this.getClass().getResourceAsStream(
                    "/META-INF/maven/com.sp.infra.svc.gov/sp-infra-svc-gov-sdk/pom.properties");
            if(is != null){
                properties.load(is);
