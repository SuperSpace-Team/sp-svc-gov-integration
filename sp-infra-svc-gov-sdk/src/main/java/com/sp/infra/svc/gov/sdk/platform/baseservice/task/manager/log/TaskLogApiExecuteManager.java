package com.sp.infra.svc.gov.sdk.platform.baseservice.task.manager.log;
 ...
 * task 日志收集接口
 * 1、dubbo实现:
 * <dubbo:reference  url=""  id="taskLogApiExecuteManager" interface="com.sp.infra.platform.baseservice.task.manager.log.TaskLogApiExecuteManager" check="false"/>
 *
 * 2、http实现:
