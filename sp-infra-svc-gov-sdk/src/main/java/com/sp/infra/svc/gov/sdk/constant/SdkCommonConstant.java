package com.sp.infra.svc.gov.sdk.constant;
...
public final class SdkCommonConstant {
     ...
     * 默认治理平台BFF服务URL
     */
    public static final String DEFAULT_SERVICE_GOVERNANCE_PLATFORM_URL = DEFAULT_UNION_GATEWAY_URL + "/svc-gov";

    /**
     * 治理平台基础服务相关接口调用
     * 初始化获取应用鉴权码
     */
    public static final String INVOKE_SVC_GOV_API_GET_APP_AUTH_CODE = "/getAppAuthCode";
    public static final String INVOKE_SVC_GOV_API_EXEC_APP_LOGIN = "/login";
    public static final String INVOKE_SVC_GOV_API_REFRESH_NEW_APP_TOKEN = "/refreshNewToken";
    ...
    /** 用于服务治理平台基础服务 **/
    public static final int PG_APP_TOKEN_REFRESH_IN_ADVANCE = 30 * 60 * 1000; //提前30分钟进行refresh
    public static final String PG_CANNOT_GET_TOKEN = "5001"; //出于某种原因，无法取得token，该错误不是治理平台基础服务返回，是本地的错误
    ...
    public static final String ALM_CALLBACK_CLASSPATH_NAME = "com.sp.infra.svc.gov.agent.alm.callback.impl.AlmCallbackServiceImpl";
    public static final String AGENT_REGISTRY_CLASSPATH_NAME = "com.sp.infra.svc.gov.agent.agent.AgentBeanRegistry";
    public static final String ALM_REGISTRY_CLASSPATH_NAME = "com.sp.infra.svc.gov.sdk.init.context.BeanRegistryProxy";
    public static final String AGENT_ALM_MONITOR_SERVICE_NAME = "com.sp.infra.svc.gov.sdk.alm.service.MonitorService";
    public static final String AGENT_INSTALL_PROCESSOR_CLASSPATH_NAME = "com.sp.infra.svc.gov.agent.agent.AgentInstallProcessor";
