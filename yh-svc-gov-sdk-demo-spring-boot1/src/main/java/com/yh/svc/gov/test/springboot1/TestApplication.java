...
@SpringBootApplication(scanBasePackages = { "com.yh.svc.gov.test", "com.yh.svc.gov.test.springboot1.log", "com.yh.infra.svc.gov.platform.baseservice.message","com.yh.infra.svc.gov.sdk.files.manager"})
