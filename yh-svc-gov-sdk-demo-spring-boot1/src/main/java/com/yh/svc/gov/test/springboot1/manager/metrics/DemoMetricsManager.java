...
public class DemoMetricsManager  {
	...
	public void createOrder(int sleepMs) {
		logger.info("create order ... {}", sleepMs);
	...
	public void createDo(int sleepMs) {
		...
		// 记录timer 指标的值
		helper.update("yh.infra.demo.timer.test1.dev", MetricsType.TIMER, 0, end-start, TimeUnit.MILLISECONDS, "app", "demo-sb2", "project", "YhInfra", "function", "demo-sb2-createDo");
	}
	...
	public void createSo() {
		...
		logger.info("create so ... {}, {}, {}, {}", summaryValue, s2, s3,s4);
		count += 4;
		...
		logger.info("create so ... {}, {}, {}, {}, count : {}, max: {}, sum: {}", summaryValue, s2, s3,s4, count, max, sum);
		// mock 结束
