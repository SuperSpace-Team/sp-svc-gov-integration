...
//import com.yh.svc.gov.test.springboot1.manager.impl.RetryManager2Impl;
//import com.yh.infra.svc.gov.sdk.retry.vo.RetryResponse;
//
//@RestController
//@RequestMapping("/retry2")
//public class Retry2Controller {
//	private static final Logger logger = LoggerFactory.getLogger(Retry2Controller.class);
//
//	@Autowired
//	private RetryManager2Impl retryManager;
//
//	@GetMapping("/normal")
//	public boolean normal(@RequestParam(value="type")int type, @RequestParam(value="uuid")String uuid, @RequestParam(value="bizKey")String bizKey, @RequestParam(value="timeout")int timeout) throws InterruptedException {
...
//	public boolean asyncResp(@RequestParam(value="type")int type, @RequestParam(value="uuid")String uuid, @RequestParam(value="appKey")String appKey) throws InterruptedException {
//		logger.info("asyncResp {}, {}", type, uuid);
//		Map<String, Object> parameters = new HashMap<>();
//		parameters.put("datakey", "dataValue");
//		return retryManager.asyncResp(type, uuid, appKey);
//	}
//
//
//}
