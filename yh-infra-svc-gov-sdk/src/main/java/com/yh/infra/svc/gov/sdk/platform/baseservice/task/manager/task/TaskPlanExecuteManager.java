 ...
 * ALL Rights Reserved.
 */
package com.yh.infra.svc.gov.sdk.platform.baseservice.task.manager.task;
 ...
 * 任务执行时间收集
 * 1、dubbo接口实现
 * <dubbo:reference url=""  id="taskPlanExecuteManager" interface="com.yh.infra.platform.baseservice.task.manager.task.TaskPlanExecuteManager" check="false"/>
 *
 * 2、http接口实现
