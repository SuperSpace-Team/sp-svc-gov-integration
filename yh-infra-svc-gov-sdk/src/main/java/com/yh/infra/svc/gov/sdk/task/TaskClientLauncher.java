/**
 * Copyright (c) 2019 Yonghui All Rights Reserved.
 *
 ...
 *
 */
package com.yh.infra.svc.gov.sdk.task;
...
import com.yh.infra.svc.gov.sdk.task.support.HttpTaskExecutor;
import com.yh.infra.svc.gov.sdk.task.support.TaskCallBackManager;
import com.yh.infra.svc.gov.sdk.task.support.impl.HttpTaskExecutorImpl;
import com.yh.infra.svc.gov.sdk.task.support.impl.TaskCallBackManagerImpl;
import com.yh.infra.svc.gov.sdk.util.NetUtils;
import com.yh.infra.svc.gov.sdk.util.SpringUtil;
