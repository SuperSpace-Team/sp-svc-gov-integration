...
import com.yh.infra.svc.gov.sdk.alm.context.ResponseStatusEnum;
...
public class SendLogService_2Test {
	...
	private AppConfig prepareAC() {
		...
		Entry entry = TestVoUtil.voEntry(21, "com.yh.infra.svc.gov.sdk.util.OrderService", "createOrder", "String,Integer", "");
		appConfig.getEntries().add(entry);
		entry = TestVoUtil.voEntry(22, "com.yh.infra.svc.gov.sdk.util.DummyService", "createOrder", "String,Integer", "");
		appConfig.getEntries().add(entry);
		entry = TestVoUtil.voEntry(23, "com.yh.infra.svc.gov.sdk.util.OrderServiceImpl", "createOrder", "String,Integer", "");
		appConfig.getEntries().add(entry);
