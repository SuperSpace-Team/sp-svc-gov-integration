package com.sp.infra.svc.gov.consul.retry;


import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;

import com.sp.infra.svc.gov.consul.retry.config.ConsulRetryProperties;
import com.sp.infra.svc.gov.consul.retry.thread.RetryThread;
